...
INSERT INTO Arcade_Machine_Info (Machine_id, Machine_Number, Game, Year, Floor) VALUES
('M1', 123, 'Mario', 2005, 1),
...
DELETE FROM Arcade_Machine_Info
WHERE Game = 'Mario';
